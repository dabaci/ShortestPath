...
public class Main {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        System.out.println(lengthDij + " mins");
        System.out.println((endDij - startDij) / 1000000 + " ms");
        ...
        System.out.println(lengthBF + " mins");
        System.out.println((endBF - startBF) / 1000000 + " ms");
    }
}
